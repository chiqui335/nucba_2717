...
class User {
    ...
    public function cancelarTurno($turno_id){ //REVISAR
        $sql = "UPDATE turno SET estado = 'Cancelado' WHERE id_paciente = ? AND id_profesional = ?";
    ...
    public function obtenerTurnos($user_id, $role) {

         // Obtener la instancia única de la clase Database
            $db = Database::obtenerInstancia();  
            $conn = $db->obtenerConexion();  // Obtener la conexión a la base de datos
