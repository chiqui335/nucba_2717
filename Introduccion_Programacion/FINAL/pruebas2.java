...
public class pruebas2 {
    public static void main(String[] args){
        ...
        ImageIcon [][] deckImg = new ImageIcon [4][10];
                                        ...
                                        //nombreclase es el nomhbre del archivo aca pruebas2
        deckImg[0][0] = new ImageIcon (nombreclase.class.getResource("/FINAL/Cartas/esp1.png"));
        deckImg[0][1] = new ImageIcon ("/FINAL/Cartas/esp2.png");
        deckImg[0][2] = new ImageIcon ("/FINAL/Cartas/esp3.png");
        deckImg[0][3] = new ImageIcon ("/FINAL/Cartas/esp4.png");
        deckImg[0][4] = new ImageIcon ("/FINAL/Cartas/esp5.png");
        deckImg[0][5] = new ImageIcon ("/FINAL/Cartas/esp6.png");
        deckImg[0][6] = new ImageIcon ("/FINAL/Cartas/esp7.png");
        deckImg[0][7] = new ImageIcon ("/FINAL/Cartas/esp10.png");
        deckImg[0][8] = new ImageIcon ("/FINAL/Cartas/esp11.png");
        deckImg[0][9] = new ImageIcon ("/FINAL/Cartas/esp12.png");
        deckImg[1][0] = new ImageIcon ("/FINAL/Cartas/basto1.png"); 
        deckImg[1][1] = new ImageIcon ("/FINAL/Cartas/basto2.png");
        deckImg[1][2] = new ImageIcon ("/FINAL/Cartas/basto3.png"); 
        deckImg[1][3] = new ImageIcon ("/FINAL/Cartas/basto4.png");
        deckImg[1][4] = new ImageIcon ("/FINAL/Cartas/basto5.png");
        deckImg[1][5] = new ImageIcon ("/FINAL/Cartas/basto6.png");
        deckImg[1][6] = new ImageIcon ("/FINAL/Cartas/basto7.png");
        deckImg[1][7] = new ImageIcon ("/FINAL/Cartas/basto10.png");
        deckImg[1][8] = new ImageIcon ("/FINAL/Cartas/basto11.png");
        deckImg[1][9] = new ImageIcon ("/FINAL/Cartas/basto12.png");
        deckImg[2][0] = new ImageIcon ("/FINAL/Cartas/oro1.png");
        deckImg[2][1] = new ImageIcon ("/FINAL/Cartas/oro2.png");
        deckImg[2][2] = new ImageIcon ("/FINAL/Cartas/oro3.png");
        deckImg[2][3] = new ImageIcon ("/FINAL/Cartas/oro4.png");
        deckImg[2][4] = new ImageIcon ("/FINAL/Cartas/oro5.png");
        deckImg[2][5] = new ImageIcon ("/FINAL/Cartas/oro6.png");
        deckImg[2][6] = new ImageIcon ("/FINAL/Cartas/oro7.png");
        deckImg[2][7] = new ImageIcon ("/FINAL/Cartas/oro10.png");
        deckImg[2][8] = new ImageIcon ("/FINAL/Cartas/oro11.png");
        deckImg[2][9] = new ImageIcon ("/FINAL/Cartas/oro12.png");
        deckImg[3][0] = new ImageIcon ("/FINAL/Cartas/copa1.png");
        deckImg[3][1] = new ImageIcon ("/FINAL/Cartas/copa2.png");
        deckImg[3][2] = new ImageIcon ("/FINAL/Cartas/copa3.png");
        deckImg[3][3] = new ImageIcon ("/FINAL/Cartas/copa4.png");
        deckImg[3][4] = new ImageIcon ("/FINAL/Cartas/copa5.png");
        deckImg[3][5] = new ImageIcon ("/FINAL/Cartas/copa6.png");
        deckImg[3][6] = new ImageIcon ("/FINAL/Cartas/copa7.png");
        deckImg[3][7] = new ImageIcon ("/FINAL/Cartas/copa10.png");
        deckImg[3][8] = new ImageIcon ("/FINAL/Cartas/copa11.png");
        deckImg[3][9] = new ImageIcon ("/FINAL/Cartas/copa12.png");
