...
public class GarajeTest {
    public static void main(String[] args) {
        ...
        // Se crea un garaje
        Garaje garaje = new Garaje(1, 5, 1000); // Ejemplo de precio de cambio de rueda

        // Crear vehículos
        Vehiculo moto1 = new Moto("BMW", 15000, 2, 1, 150);
        ...
        garaje.agregarVehiculo(coche1); //output: "el vehiculo ya esta en el garaje"
        garaje.agregarVehiculo(coche2);
        garaje.agregarVehiculo(coche3);
        garaje.quitarVehiculo(coche1);
        garaje.quitarVehiculo(coche1); // output: "el vehiculo no esta en el garaje"
        garaje.agregarVehiculo(coche1);
        garaje.agregarVehiculo(moto3);
        garaje.agregarVehiculo(moto1);
        garaje.agregarVehiculo(moto2);  // output: "garaje lleno"
        garaje.quitarVehiculo(moto2); // output: "el vehiculo no esta en el garaje"

        // Cambiar número de ruedas especifico de un vehículo
        garaje.precioCambio(coche1, 3);

        // precio de cambio de todas las ruedas de todos los vehiculos en el garaje
        garaje.precioCambio(); 

        // precio de cambio de todas las ruedas del vehiculo elegido
        garaje.precioCambio(moto1); 
        
        // Cambiar número de ruedas especifico del vehículo elegido
        garaje.precioCambio(coche1, 3); 
